...
$router
    ...
    ->register('/car', [ListingController::class, 'list_car'])
    ->register('/smartphone', [ListingController::class, 'list_smartphone'])
    ->register('/public/housing-renting', [ListingController::class, 'list_house'])
    ->register('/laptop', [ListingController::class, 'list_pc'])
